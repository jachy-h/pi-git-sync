...
export interface PiSyncConfigOverrides extends Omit<Partial<PiSyncConfig>, "security"> {
  security?: Partial<PiSyncConfig["security"]>;
}

export function createPiSyncConfig(overrides: PiSyncConfigOverrides = {}): PiSyncConfig {
